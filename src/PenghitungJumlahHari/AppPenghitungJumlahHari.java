 ...
 * @author ACER
 */
public class AppPenghitungJumlahHari extends javax.swing.JFrame {

    /**
     * Creates new form AppPenghitungJumlahHari
     */
    public AppPenghitungJumlahHari() {
        initComponents();
    }
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addComponent(cmbBulan, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(jLabel2)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(fldTahun, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        if(fldTahun.getText().isEmpty()){
            ...
            if(cmbBulan.getSelectedItem().equals("Februari")){
                if(((tahun % 4== 0)&&!(tahun % 100 == 0))||(tahun % 400 == 0))
                    ...
                    cmbBulan.getSelectedItem().equals("April")||
             ...
             lblJumlah.setText("Jumlah Hari pada Bulan " + cmbBulan.getSelectedItem()+ " Tahun "+tahun+" adalah "+jumlahHari+" Hari");
        }
    ...
    private void fldTahunKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_fldTahunKeyTyped
        ...
        if (!((Character.isDigit(c)||(c== KeyEvent.VK_BACKSPACE)||(c == KeyEvent.VK_DELETE))
            ...
            getToolkit().beep();
            JOptionPane.showMessageDialog(null,"input nilai bukan numerik (digit)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AppPenghitungJumlahHari.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
